...
$$
\text{Real Home Price}*{r,t}
= \frac{\text{ZHVI}*{r,t}}{\text{CPI}_t} \times 100
$$
...
Mortgage_rate_monthly interpretation

One percentage point annual increase

A 1 pp annual rate increase = 0.01 / 12 ≈ 0.00083 monthly

Δlog(Affordability)≈−242×0.00083≈−0.20

Δlog(Y)≈%ΔY

A 1 percentage point increase in the annual mortgage rate is associated with approximately a 20% decline in housing affordability.

Affordability exhibits approximately unit elasticity with respect to both real home prices and household income. A 1% increase in real prices reduces affordability by roughly 1%, while a 1% increase in income raises affordability by a similar magnitude. This confirms that long-run affordability dynamics are governed by the relative growth of prices and income.
